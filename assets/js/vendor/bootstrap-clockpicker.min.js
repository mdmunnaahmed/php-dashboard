    ...
    function s(s, r) {
        ...
        if (
            ...
            n(
                ...
                .on("click", function () {
                    (x.amOrPm = "AM"),
                        n(".clockpicker-span-am-pm").empty().append("AM");
                })
        ...
        r.autoclose ||
            n(
                '<button type="button" class="btn btn-sm btn-default w-100 clockpicker-button">' +
                    r.donetext +
                    "</button>"
            )
        ...
        if (
            (u.on(k, function (t) {
                0 === n(t.target).closest(".clockpicker-tick").length &&
                    p(t, !0);
            }),
            l)
        ) {
            ...
            var X = t("circle");
            X.setAttribute("class", "clockpicker-canvas-bg"),
                X.setAttribute("r", y);
            var Y = t("circle");
        ...
        (s.prototype.resetClock = function (t) {
            ...
            l && t
                ? (p.canvas.addClass("clockpicker-canvas-out"),
                  setTimeout(function () {
                      p.canvas.removeClass("clockpicker-canvas-out"),
                          p.setHand(r, a);
                  }, t))
                : this.setHand(r, a);
        }),
