      ...
      <div class="bodywrapper__inner">
        ...
        <div class="row align-items-center mb-30">
          <div class="col-lg-6 col-6">
            <h6 class="page-title">Sidebar</h6>
        ...
        <div class="docs-wrapper">
          <h2 class="docs__title">Sidebar Customization</h2>
          <p class="mb-50">You can easily change or apply sidebar <b>backround color and image.</b></p>
          <div>
            <h5 class="mb-3">add sidebar solid background color</h5>
            <p class="docs__info mb-3"><i class="las la-info-circle"></i>If you want to change or apply sidebar <b>solid background-color</b>, just add some class.. like <code>bg--dark, bg--white</code> and you can also use more bg color from<a href="docs-bg-color.html" target="_blank"> bg color documentation</a></p>
            <div class="row">
              <div class="col-lg-6">
                <img src="assets/images/ss/sb-1.jpg" alt="image">
              </div>
              <div class="col-lg-6">
                <img src="assets/images/ss/sidebar-1.jpg" alt="image">
              </div>
            </div>
          </div>

          <div class="mt-50">
            <h5 class="mb-3">add sidebar gradient background color</h5>
            <p class="docs__info mb-3"><i class="las la-info-circle"></i>If you want to change or apply sidebar <b>gradient background-color</b>, just add some class.. like <code>bg--gradi-1, bg--gradi-2, bg--gradi-3</code> and you can also use more bg color from<a href="docs-bg-color.html" target="_blank"> sbg color documentation</a></p>
            <div class="row">
              <div class="col-lg-6">
                <img src="assets/images/ss/sb-2.jpg" alt="image">
              </div>
              <div class="col-lg-6">
                <img src="assets/images/ss/sidebar-2.jpg" alt="image">
              </div>
            </div>
          </div>

          <div class="mt-50">
            <h5 class="mb-3">add sidebar background image with overlay</h5>
            <p class="docs__info mb-3"><i class="las la-info-circle"></i>If you want to change or apply sidebar <b>overlay-color with background-image</b>, just add class for overlay <code>overlay--dark, overlay--white, overlay--gradi-1, overlay--gradi-2, overlay--gradi-3</code> <b>important note: must use <code>.bg_img</code> class for add background image</b></p>
            <div class="row">
              <div class="col-lg-6">
                <img src="assets/images/ss/sb-3.jpg" alt="image">
              </div>
              <div class="col-lg-6">
                <img src="assets/images/ss/sidebar-3.jpg" alt="image">
              </div>
            </div>
          </div>

          <div class="mt-50">
            <h5 class="mb-3">add capsule style for menu item</h5>
            <p class="docs__info mb-3"><i class="las la-info-circle"></i>If you want to change or apply sidebar <b>capsule style</b>, just add class <code>capsule--rounded, capsule--rounded2</code></p>
            <div class="row">
              <div class="col-lg-6">
                <img src="assets/images/ss/sb-4.jpg" alt="image">
              </div>
              <div class="col-lg-6">
                <img src="assets/images/ss/sidebar-4.jpg" alt="image">
              </div>
            </div>
          </div>
        </div>
