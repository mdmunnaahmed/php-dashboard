      ...
      <div class="bodywrapper__inner">
        ...
        <div class="row mb-none-30">
          <div class="col-lg-4 col-md-4 mb-30">
            <div class="card">
              <div class="card-body text-center border-bottom">
                <img src="assets/images/user/1.jpg" alt="profile-image" class="user-image">
                <h5 class="card-title mt-3">Fahad Bin Faiz</h5>
              ...
              <div class="card-body">
                ...
                <p class="clearfix">
                  ...
                  <span class="float-right text-muted">665465454</span>
                </p>
                <p class="clearfix">
                  <span class="float-left">Mail</span>
                  <span class="float-right text-muted">info@mail.com</span>
                </p>
                <p class="clearfix">
                  <span class="float-left">Facebook</span>
                  <span class="float-right text-muted"><a href="#0">@fahaddevs</a></span>
                </p>
                <p class="clearfix">
                  <span class="float-left">Github</span>
                  <span class="float-right text-muted"><a href="#0">@fahaddevs</a></span>
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-8 col-md-8 mb-30">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title mb-50 border-bottom pb-2">User personal information</h5>
                <form>
