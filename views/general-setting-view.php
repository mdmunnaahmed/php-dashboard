...
$data = $admin_obj->displaySetting();
$info = mysqli_fetch_assoc($data);
$row = mysqli_num_rows($data);
if ($row == 0) {
    if (isset($_POST['submit-btn'])) {
        $msg = $admin_obj->setting($_POST);
    }
} else {
    if (isset($_POST['submit-btn'])) {
        $msg = $admin_obj->updateSetting($_POST);
    }
}
...
<div class="card">
    <div class="card-body">
        <form method="POST">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg" type="text" name="site_title" value="<?php echo $info['site_title'] ?? '' ?>" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Currency</label>
                        <input class="form-control form-control-lg" type="text" name="currency" value="<?php echo $info['currency'] ?? '' ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg" type="text" name="currency_symbol" value="<?php echo $info['currency_symbol'] ?? '' ?>" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon ">
                            <input type='text' class="form-control form-control-lg colorPicker" value="<?php echo $info['base_color'] ?>">
                        </span>
                        <input type="text" class="form-control form-control-lg colorCode" name="base_color" value="<?php echo $info['base_color'] ?? '' ?>" required>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                            <input type='text' class="form-control form-control-lg colorPicker" value="<?php echo $info['secondary_color'] ?>">
                        </span>
                        <input type="text" class="form-control form-control-lg colorCode" name="secondary_color" value="<?php echo $info['secondary_color'] ?? "" ?>" required>
                    </div>
                </div>
                <!-- 
                <div class="form-group col-md-4">
            ...
            <div class="form-group">
                <button type="submit" name="submit-btn" class="btn btn--primary w-100 h-45">Update</button>
            </div>
        </form>
    </div>
</div>
