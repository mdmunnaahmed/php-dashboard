      ...
      <div class="body-wrapper__inner">
        <div class="row align-items-center mb-30">
          <div class="col-lg-6 col-6">
            <h6 class="page-title">Other documentation parts</h6>
        ...
        <div class="docs-wrapper">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Media size variation</h5>
          ...
          <div class="card mt-30">
            <div class="card-body">
              ...
              <div class="col-lg-4 p-4 box--shadow1 mb-30">
                <span>.box--shadow1</span>
              </div>
              <div class="col-lg-4 p-4 box--shadow2 mb-30">
                <span>.box--shadow2</span>
              </div>
              <div class="col-lg-4 p-4 box--shadow3">
                <span>.box--shadow3</span>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="row mb-none-30">
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--none">
                    <span class="text-white">.b-radius--none</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--3">
                    <span class="text-white">.b-radius--3</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--4">
                    <span class="text-white">.b-radius--4</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--5">
                    <span class="text-white">.b-radius--5</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--6">
                    <span class="text-white">.b-radius--6</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--7">
                    <span class="text-white">.b-radius--7</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--8">
                    <span class="text-white">.b-radius--8</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--9">
                    <span class="text-white">.b-radius--9</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--10">
                    <span class="text-white">.b-radius--10</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="bg--danger b-radius--rounded pt-3" style="width: 120px; height: 120px; text-align: center;">
                    <span class="text-white">.b-radius--rounded</span>
                  </div>
                </div>
                <div class="col-lg-2  mb-30">
                  <div class="py-5 px-3 bg--danger b-radius--capsule">
                    <span class="text-white">.b-radius--capsule</span>
                  </div>
                </div>
              </div><!-- row end -->
            </div>
