...
<head>
  ...
  <div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="assets/images/bg/1.jpg">
      <div class="form-wrapper">
        <h4 class="logo-text mb-10">Welcome to <strong>Thesoftking</strong></h4>
        <p>Reset your password</p>
        <form class="cmn-form mt-30">
          <div class="form-group">
            <label for="email">Please enter your email address</label>
            <input type="email" class="form-control b-radius--capsule" id="email" placeholder="email@gmail.com">
            <i class="las la-user input-icon"></i>
          </div>
          <small class="text--small text-muted"><i class="las la-info-circle"></i> You'll recieve a link to create a new password via email</small>
          <div class="form-group">
            <button type="submit" class="submit-btn mt-25 b-radius--capsule">Submit <i class="las la-sign-in-alt"></i></button>
          </div>
        </form>
      </div>
    </div><!-- login-area end -->
