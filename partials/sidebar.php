    <!-- sidebar start -->
    <div class="sidebar capsule--rounded bg_img overlay--dark bg--gradi-19">
        <button class="res-sidebar-close-btn"><i class="las la-times"></i></button>
        <div class="sidebar__inner">
            <div class="sidebar__logo">
                <a href="dashboard.php" class="sidebar__main-logo"><img src="assets/images/logo2.png" alt="image"></a>
                <a href="dashboard.php" class="sidebar__logo-shape"><img src="assets/images/logo-shape.png" alt="image"></a>
