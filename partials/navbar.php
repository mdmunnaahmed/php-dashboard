    ...
    <nav class="navbar-wrapper">
        <div class="navbar__left">
            ...
            <form class="navbar-search">
                <input type="search" name="#0" class="navbar-search-field" id="#0" autocomplete="off" placeholder="Search here...">
            ...
            <ul class="navbar__action-list">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu--sm p-0 border-0 box--shadow1 dropdown-menu-right">
                        ...
                        <a href="?adminLogout=logout" class="dropdown-menu__item d-flex align-items-center px-3 py-2">
